...
(check-exn (regexp (regexp-quote "expected a number, got ~e"))
           (lambda () (ohno 'chris)))
;Problem 6
...
(define (interp [arith : ArithC]) : Real
  (match arith
    ...
    [(expC num) (* (interp num) (interp num))]))
...
(check-exn (regexp (regexp-quote "Syntax error, got ~e"))
           (lambda () (parse '{})))
