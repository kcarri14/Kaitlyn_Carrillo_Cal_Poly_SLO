...
public class Main {
    ...
    public static Cat CAT_A = new Cat("Steven", 6);
    public static Cat CAT_B = new Cat("KaitlynKaitlynKaitlynKaitlynKaitlynKaitlynKaitlynKaitlynKavehKavehKavehKavehKavehKavehKavehKavehKavehKaveh", -31);
